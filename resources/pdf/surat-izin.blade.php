...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: "Times New Roman", Times, serif; font-size: 12pt; color: #111; padding: 32px 48px; }
        table { border-collapse: collapse; width: 100%; }
        img { max-width: 100%; }
        .kop { border-bottom: 4px double #111; margin-bottom: 16px; padding-bottom: 8px; }
        .kop td { vertical-align: middle; }
        .kop img { width: 70px; }
        .kop-text { text-align: center; line-height: 1.4; }
        .instansi { font-size: 10pt; }
        .dinas { font-size: 11pt; font-weight: bold; }
        .sekolah { font-size: 14pt; font-weight: bold; }
        .kota { font-size: 14pt; font-weight: bold; }
        .alamat { font-size: 9pt; }
        .judul { text-align: center; margin: 16px 0; }
        .judul h1 { font-size: 13pt; text-transform: uppercase; text-decoration: underline; }
        .nomor { font-size: 10pt; margin-top: 4px; }
        .meta-surat td { padding: 2px 0; font-size: 11pt; }
        .label { width: 110px; }
        .colon { width: 14px; }
        .section-box { border: 0.5px solid #bbb; margin-bottom: 12px; }
        .section-header { background: #e8e8e8; padding: 5px 10px; font-size: 10pt; font-weight: bold; }
        .section-body td { padding: 5px 10px; font-size: 11pt; }
        .penutup { margin: 14px 0 20px; line-height: 1.6; }
        .ttd { text-align: center; font-size: 11pt; }
        .ttd .nama { margin-top: 10px; margin-bottom: 4px; font-weight: bold; text-decoration: underline; }
        .stempel-wrapper { text-align: center; margin-top: -10px; margin-bottom: -20px; }
        .approve-img { width: 150px; opacity: 0.8; }
    </style>
</head>
<body>
        ...
        <table>
            <tr>
                <td width="80" align="center">
                    <img src="{{ public_path('images/logo jawa tengah.png') }}">
                </td>
                <td align="center">
                    <div class="kop-text">
            ...
            <td width="33%" class="ttd" style="padding-top:20px;">
                Semarang, {{ $izin->created_at->translatedFormat('d F Y') }}
                    ...
                    <div class="stempel-wrapper">
                        <img src="{{ public_path('images/approve.png') }}" class="approve-img">
                    </div>
