...
<div id="modal" class="modal-overlay">
    ...
    <div class="modal-box">
        ...
        <div class="modal-actions">
            <button class="btn-kembali" onclick="closeModal()">Lanjutkan Pengajuan</button>
            <button class="btn-submit" onclick="cancelIzin()" style="background: #F24141; color: #FCFCFC; border: 1px solid #F56666;">Batalkan Pengajuan</button>
        </div>
