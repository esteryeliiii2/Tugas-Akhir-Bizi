...
<div class="izin-layout">
    ...
    <div class="izin-form">
            ...
            <div class="guru-list">
                ...
                <div class="guru-card">
                    ...
                    <div class="guru-info">
                        ...
                        <div class="guru-name">Retno Yolanda, S.Pd.</div>
                    </div>
                </div>
                ...
                <div class="guru-card">
                    ...
                    <div class="guru-info">
                        ...
                        <div class="guru-name">Agus Setyawan, S.Pd.</div>
                    </div>

                    <iconify-icon icon="tabler:selector" class="guru-arrow"></iconify-icon>
                </div>
        ...
        <div class="form-actions">
            <button class="btn-kembali" onclick="window.location.href='ajukan-izin'">
                Kembali
            </button>
...
<div id="modal" class="modal-overlay">
    ...
    <div class="modal-box">
        ...
        <div class="modal-actions">
            <button class="btn-kembali" onclick="closeModal()">Periksa kembali</button>
            <button class="btn-submit" onclick="submitIzin()">Ajukan sekarang</button>
        </div>
